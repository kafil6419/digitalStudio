...
<body>
   <div class="container">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-5">
                            <center><img class="rounded-circle my-4" src="img_avatar.png" height="100px" width="100px"></center>
                        </div>
                    </div>
                    <div class="row justify-content-center">
                        <div class="col-sm-5">
        ...
        <?php
            if(isset($_POST['sbmt_'])){
                if($_POST['email']=="admin@gmail.com"){
                    if($_POST['pswd']=="ApnaStudio"){
                        session_start();
                        $_SESSION['name']=$_POST['name'];
                        header("Location: http://localhost/Studio/Admin/Home.php");
                    }
                    else{
